...
function Card({name, title, content, date, readingTime} ) {

  return (
    <div>
    <a href="#" className="block rounded-md border border-gray-300 p-4 shadow-sm sm:p-6 bg-white max-w-sm mx-auto">
